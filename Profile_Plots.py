...
layerList = open(PyFolder + '/AM_input/raster_file.txt').read().splitlines()
#print layerList

# Assign the filename: file
file = PyFolder + '/AM_output/transect_table.csv'
...
Color_Dict[layerList[3]]='g'
Color_Dict[layerList[4]]='m'
Color_Dict[layerList[5]]='y'
Color_Dict[layerList[6]]='k'
Color_Dict[layerList[7]]='c:'
Color_Dict[layerList[8]]='r'
